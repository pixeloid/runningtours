...
class Paginate
{
    ...
    static public function createCountQuery(Query $query)
    {
        ...
        $countQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('Beberlei\Paginate\CountWalker'));
    ...
    static public function createLimitSubQuery(Query $query, $offset, $itemCountPerPage)
    {
        ...
        $subQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('Beberlei\Paginate\LimitSubqueryWalker'))
    ...
    static public function createWhereInQuery(Query $query, array $ids, $namespace = 'pgid')
    {
        ...
        if (count($ids) > 0) {
            ...
            $whereInQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('Beberlei\Paginate\WhereInWalker'));
